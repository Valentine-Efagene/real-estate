...
import { useWallet, useTransactions, TransactionType, TransactionStatus, type Transaction } from '@/lib/hooks/use-wallet';
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-500 mt-1">View your wallet balance and transaction history</p>
            </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {walletLoading ? (
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-400">Your wallet will be auto-created when a payment phase starts.</p>
                            </div>
                        )}
                    </div>
                </CardContent>
                ...
                <CardContent>
                    {txLoading ? (
                        ...
                        <div className="text-center py-12 text-gray-500">
                            ...
                            <p className="text-sm mt-1">Transactions will appear here when you fund your wallet or make payments.</p>
                        </div>
                    )}
                </CardContent>
            </Card>
...
export default function AdminTransactionsPage() {
    return (
        <ProtectedRoute roles={['admin', 'mortgage_ops', 'finance']}>
            <TransactionsContent />
        </ProtectedRoute>
    );
}
