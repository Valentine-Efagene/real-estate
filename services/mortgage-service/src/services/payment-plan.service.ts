    ...
    async function create(tenantId: string, data: CreatePaymentPlanInput) {
        ...
        const plan = await prisma.paymentPlan.create({
            data: {
                ...
                termStepMonths: data.termStepMonths,
                maxAgeAtMaturity: data.maxAgeAtMaturity,
                collectFunds: data.collectFunds ?? true,
    ...
    async function clone(id: string, newName: string) {
        ...
        const cloned = await prisma.paymentPlan.create({
            data: {
                ...
                termStepMonths: source.termStepMonths,
                maxAgeAtMaturity: source.maxAgeAtMaturity,
                collectFunds: source.collectFunds,
